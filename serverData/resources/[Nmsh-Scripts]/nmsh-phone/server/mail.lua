...
RegisterNetEvent('nmsh-phone:server:RemoveMail', function(MailId)
    local src = source
    ...
    SetTimeout(100, function()
        ...
        TriggerClientEvent('nmsh-phone:client:UpdateMails', src, mails)
    end)
end)


RegisterNetEvent('nmsh-phone:server:sendNewMail', function(mailData, citizenID)
    ...
    if Player then
        ...
        TriggerClientEvent('nmsh-phone:client:NewMailNotify', Player.PlayerData.source, mailData)
        ...
        SetTimeout(200, function()
            ...
            TriggerClientEvent('nmsh-phone:client:UpdateMails', Player.PlayerData.source, mails)
        end)
...
function sendNewMailToOffline(citizenid, mailData)
    ...
    if Player then
        ...
        if mailData.button == nil then
            ...
            TriggerClientEvent('nmsh-phone:client:NewMailNotify', src, mailData)
        else
