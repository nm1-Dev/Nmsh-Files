...
RegisterNetEvent('nmsh-phone:server:Send_lsbn_ToChat', function(data)
    ...
    TriggerClientEvent('nmsh-phone:LSBN-reafy-for-add', -1, Tables, true, data.Text)
end)

RegisterNetEvent('nmsh-phone:server:GetLSBNchats', function()
    local src = source
    TriggerClientEvent('nmsh-phone:LSBN-reafy-for-add', src, LSBNTable, false, nil)
end)