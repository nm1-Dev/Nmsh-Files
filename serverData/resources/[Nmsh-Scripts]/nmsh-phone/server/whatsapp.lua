...
RegisterNetEvent('nmsh-phone:server:UpdateMessages', function(ChatMessages, ChatNumber)
    ...
    if TargetData then
        ...
        if Chat[1] then
            ...
            TriggerClientEvent('nmsh-phone:client:UpdateMessages', TargetData.PlayerData.source, ChatMessages, SenderData.PlayerData.charinfo.phone, false)
        else
            ...
            TriggerClientEvent('nmsh-phone:client:UpdateMessages', TargetData.PlayerData.source, ChatMessages, SenderData.PlayerData.charinfo.phone, true)
        end
    else
