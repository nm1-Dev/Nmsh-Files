...
RegisterNUICallback('AcceptMailButton', function(data, cb)
    ...
    TriggerServerEvent('nmsh-phone:server:ClearButtonData', data.mailId)
    cb('ok')
end)
...
RegisterNUICallback('RemoveMail', function(data, cb)
    ...
    TriggerServerEvent('nmsh-phone:server:RemoveMail', MailId)
    cb('ok')
end)

-- Events

RegisterNetEvent('nmsh-phone:client:NewMailNotify', function(MailData)
...
RegisterNetEvent('nmsh-phone:client:UpdateMails', function(NewMails)
