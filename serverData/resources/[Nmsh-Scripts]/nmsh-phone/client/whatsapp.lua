...
RegisterNUICallback('SendMessage', function(data, cb)
    ...
    TriggerServerEvent('nmsh-phone:server:UpdateMessages', PhoneData.Chats[ChatNumber].messages, ChatNumber)
    SendNUIMessage({
        action = "UpdateChat",
...
RegisterNetEvent('nmsh-phone:client:UpdateMessages', function(ChatMessages, SenderNumber, New)
