...
RegisterNUICallback('PostNewTweet', function(data, cb)
    ...
    TriggerServerEvent('nmsh-phone:server:UpdateTweets', TweetMessage)
    cb("ok")
end)

RegisterNUICallback('DeleteTweet',function(data)
    TriggerServerEvent('nmsh-phone:server:DeleteTweet', data.id)
end)
...
RegisterNetEvent('nmsh-phone:client:UpdateTweets', function(src, Tweets, delete)
