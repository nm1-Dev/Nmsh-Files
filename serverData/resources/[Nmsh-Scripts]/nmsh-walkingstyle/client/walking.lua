...
RegisterNetEvent('nmsh-walks:walkpause', function()
...
RegisterNetEvent('nmsh-walks:set', function(data)
...
CreateThread(function()
    local walkId = exports['nmsh-radialmenu']:AddOption({
        id = 'walkstyles',
        title = 'Walkstyle',
        icon = 'person-walking',
        items = {
