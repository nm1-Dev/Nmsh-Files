...
RegisterCommand('clearAreaOf', function(src, args)
    ...
    if clearType == nil or clearType == 'everything' then
        TriggerClientEvent('nmsh-cleanup:clearAreaOfEverything', -1, vectors, radius + 0.0)
    elseif clearType == 'objects' then
        TriggerClientEvent('nmsh-cleanup:clearAreaOfObjects', -1, vectors, radius + 0.0)
    elseif clearType == 'vehicles' then
        TriggerClientEvent('nmsh-cleanup:clearAreaOfVehicles', -1, vectors, radius + 0.0)
    elseif clearType == 'peds' then
        TriggerClientEvent('nmsh-cleanup:clearAreaOfPeds', -1, vectors, radius + 0.0)
    end
end)