...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('nmsh-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('nmsh-admin:client:toggleBlips', function()
...
RegisterNetEvent('nmsh-admin:client:toggleNames', function()
...
RegisterNetEvent('nmsh-admin:client:Show', function(players)
