...
RegisterNetEvent('nmsh-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('nmsh-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('nmsh-radialmenu:ToggleProps', ToggleProps)
