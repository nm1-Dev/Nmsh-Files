...
--         local sizex = 1
--         local sizey = 1
--         exports["nmsh-target"]:AddBoxZone(id, pos, sizex, sizey, {
--             name = id,
--             heading = "90.0",
--             minZ = pos - 5,
--             maxZ = pos + 5
...
--     if Config.Settings.Target == "QB" then
--     exports["nmsh-target"]:RemoveZone(sendid)
--     end
--     if Config.Settings.Target == "OX" then
...
-- function Wrapper:Stash(label,weight,slots) -- Create and Open a stash in nmsh-inventory
