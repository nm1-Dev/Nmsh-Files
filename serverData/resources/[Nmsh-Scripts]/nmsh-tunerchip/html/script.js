...
$(document).on('click', '#save', function(){
    $.post('https://nmsh-tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('https://nmsh-tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('https://nmsh-tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('https://nmsh-tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('https://nmsh-tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('https://nmsh-tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
...
QBTuner.Close = function() {
    ...
    $.post('https://nmsh-tunerchip/exit');
}