...
QBCore.Functions.CreateUseableItem("tunerlaptop", function(source)
    TriggerClientEvent('nmsh-tunerchip:client:openChip', source)
end)

RegisterNetEvent('nmsh-tunerchip:server:TuneStatus', function(plate, bool)
    if bool then
...
QBCore.Functions.CreateCallback('nmsh-tunerchip:server:HasChip', function(source, cb, data)
    local src = source
...
QBCore.Functions.CreateCallback('nmsh-tunerchip:server:GetStatus', function(_, cb, plate)
