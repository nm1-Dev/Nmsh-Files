...
CreateThread(function()
    for k, v in pairs(Config.MicrophoneZones) do
        exports["nmsh-zones"]:CreateBoxZone("microphone_"..v.name, v.coords, v.length, v.width, v.data)
    end
end)
...
RegisterNetEvent("nmsh-zones:enter", function(ZoneName, ZoneData)
...
RegisterNetEvent("nmsh-zones:leave", function(ZoneName, ZoneData)
    if string.starts(ZoneName, "microphone_") then
