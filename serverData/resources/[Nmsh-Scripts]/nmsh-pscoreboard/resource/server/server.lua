local players = {}
local maxPlayers = GetConvarInt('sv_maxclients', 100)
...
RegisterNetEvent('nmsh-pscoreboard:requestData', function()
	...
	TriggerClientEvent('nmsh-pscoreboard:receiveData', source, {
		players = players,
