...
- I have added an option for people not using nmsh-target replace the menus.lua file with the menus-notarget.lua file and uncomment lines in the config folder.
...
QBCore Framework - https://github.com/qbcore-framework/nmsh-core

PolyZone - https://github.com/mkafrin/PolyZone

nmsh-target - https://github.com/BerkieBb/nmsh-target (Only needed if not using draw text)

nmsh-input - https://github.com/qbcore-framework/nmsh-input

nmsh-menu - https://github.com/qbcore-framework/nmsh-menu
...
## Copy file into @nmsh-doorlock --> configs
Copy the burgershot.lua file inside the assets folder into the doorlock configs folder

## Insert into @nmsh-smallresources --> server --> consumables.lua
```
--Burgershot
...
## Insert into @nmsh-smallresources --> config.lua
```
...
## Insert into @nmsh-core/shared/items.lua 
...
```
## Insert into @nmsh-core/shared/jobs.lua 
```
QBShared.Jobs = {
    ["burgershot"] = {
...
## Insert into @nmsh-management/client - cl_config.lua
```
Config.BossMenus = {
