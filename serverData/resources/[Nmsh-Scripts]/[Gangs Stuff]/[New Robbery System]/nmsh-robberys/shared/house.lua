...
House.MinZOffset = 45 -- how far down the shell spawns
House.MinimumHouseRobberyPolice = 0 -- how many cops on to rob house
House.MinimumTime = 5 -- what time to start robberies
House.MaximumTime = 22 -- what time to end robberies
House.Ped = "csb_reporter"  -- what ped model
House.NextRobbery = {
    item = 'laptop_green',
    chance = 50 -- amount be > this amount
}
House.pedspawnchance = 20 -- how many % ped will spawn
House.weapononechance = 80  -- % chance to have weapon one 
House.Weaponone = "weapon_pistol"
House.Weapontwo = "weapon_bullpupshotgun"
House.ShowItems = true -- shows players they are at a house and what items they need
