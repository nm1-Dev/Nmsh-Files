...
RegisterServerEvent('nmsh-drugprocessing:pickedUpCannabis', function()
	local src = source
...
RegisterServerEvent('nmsh-drugprocessing:processCannabis', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:rollJoint', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("rolling_paper", function(source, item)
    ...
    TriggerClientEvent('nmsh-drugprocessing:client:rollJoint', source, 'marijuana', item)
end)

RegisterServerEvent('nmsh-drugprocessing:bagskunk', function()
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateUseableItem("empty_weed_bag", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    TriggerClientEvent('nmsh-drugprocessing:client:bagskunk', source, 'marijuana', item)
end)
