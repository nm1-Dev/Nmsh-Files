...
RegisterServerEvent('nmsh-drugprocessing:pickedUpHydrochloricAcid', function()
	local src = source
...
RegisterServerEvent('nmsh-drugprocessing:pickedUpSodiumHydroxide', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:pickedUpSulfuricAcid', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:processChemicals', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:processTempUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:processTempDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:processMeth', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:processFailUp', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nmsh-drugprocessing:processFailDown', function()
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
