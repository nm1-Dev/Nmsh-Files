...
local function Processlsd()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('nmsh-drugprocessing:Processlsd')
...
local function Processthionylchloride()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('nmsh-drugprocessing:processThionylChloride')
...
RegisterNetEvent('nmsh-drugprocessing:processingThiChlo', function()
