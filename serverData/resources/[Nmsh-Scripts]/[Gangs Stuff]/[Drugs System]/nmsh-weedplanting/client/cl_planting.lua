...
RegisterNetEvent('nmsh-weedplanting:client:UseWeedSeed', function()
        ...
        if hit == 1 then
            ...
            if IsControlJustPressed(0, 38) then
                ...
                QBCore.Functions.Progressbar('spawn_plant', _U('place_sapling'), 2000, false, true, {
                    ...
                    TriggerServerEvent('nmsh-weedplanting:server:CreateNewPlant', dest)
                    planted = false
                    seedUsed = false
                    ClearPedTasks(ped)
...
RegisterNetEvent('nmsh-weedplanting:client:CheckPlant', function(data)
    local netId = NetworkGetNetworkIdFromEntity(data.entity)
    QBCore.Functions.TriggerCallback('nmsh-weedplanting:server:GetPlantData', function(result)
        ...
        if result.health == 0 then -- Destroy plant
            exports['nmsh-menu']:openMenu({
                ...
                },
                {
                    ...
                    params = {
                        event = 'nmsh-weedplanting:client:ClearPlant',
                        args = data.entity
                    }
                }
            })
            ...
            if PlayerJob.type == Shared.CopJob and PlayerJob.onduty then
                exports['nmsh-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        params = {
                            event = 'nmsh-weedplanting:client:HarvestPlant',
                            args = data.entity
                        }
                    },
                    {
                        ...
                        icon = 'fas fa-fire',
                        params = {
                            event = 'nmsh-weedplanting:client:PoliceDestroy',
                            args = data.entity
                        }
                    }
                })
            ...
            if PlayerJob.type == Shared.CopJob and PlayerJob.onduty then
                ...
                exports['nmsh-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        icon = 'fas fa-shower',
                        params = {
                            event = 'nmsh-weedplanting:client:GiveWater',
                            args = data.entity
                        }
                    },
                    {
                        ...
                        params = {
                            args = data.entity,
                            event = 'nmsh-weedplanting:client:GiveFertilizer',
                        }
                    },
                    {
                        ...
                        params = {
                            args = data.entity,
                            event = 'nmsh-weedplanting:client:AddMaleSeed',
                        }
                    }
                })
            end
...
RegisterNetEvent('nmsh-weedplanting:client:ClearPlant', function(entity)
    ...
    QBCore.Functions.Progressbar('clear_plant', _U('clear_plant'), 8500, false, true, {
        ...
        TriggerServerEvent('nmsh-weedplanting:server:ClearPlant', netId)
        ClearPedTasks(ped)
        RemoveAnimDict('amb@medic@standing@kneel@base')
        RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
    end, function()
...
RegisterNetEvent('nmsh-weedplanting:client:HarvestPlant', function(entity)
    local netId = NetworkGetNetworkIdFromEntity(entity)
    local ped = PlayerPedId()
    TaskTurnPedToFaceEntity(ped, entity, 1.0)
    Wait(1500)
    ...
    QBCore.Functions.Progressbar('harvest_plant', _U('harvesting_plant'), 8500, false, true, {
        ...
        TriggerServerEvent('nmsh-weedplanting:server:HarvestPlant', netId)
        ClearPedTasks(ped)
        RemoveAnimDict('amb@medic@standing@kneel@base')
        RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
    end, function()
...
RegisterNetEvent('nmsh-weedplanting:client:PoliceDestroy', function(entity)
    local netId = NetworkGetNetworkIdFromEntity(entity)
    local ped = PlayerPedId()
    TaskTurnPedToFaceEntity(ped, entity, 1.0)
    Wait(500)
    ClearPedTasks(ped)
    TriggerServerEvent('nmsh-weedplanting:server:PoliceDestroy', netId)
end)

RegisterNetEvent('nmsh-weedplanting:client:FireGoBrrrrrrr', function(coords)
    local ped = PlayerPedId()
...
RegisterNetEvent('nmsh-weedplanting:client:GiveWater', function(entity)
    if QBCore.Functions.HasItem(Shared.FullCanItem, 1) then
        ...
        QBCore.Functions.Progressbar('weedplanting_water', _U('watering_plant'), 6000, false, false, {
            ...
            TriggerServerEvent('nmsh-weedplanting:server:GiveWater', netId)
            ClearPedTasks(ped)
...
RegisterNetEvent('nmsh-weedplanting:client:OpenFillWaterMenu', function()
    exports['nmsh-menu']:openMenu({
        {
        ...
        },
        {
            ...
            params = {
                event = 'nmsh-weedplanting:client:FillWater',
            }
        }
    })
end)

RegisterNetEvent('nmsh-weedplanting:client:FillWater', function()
    ...
    QBCore.Functions.Progressbar('filling_water', _U('filling_water'), 2000, false, true, {
        ...
        TriggerServerEvent('nmsh-weedplanting:server:GetFullWateringCan')
    end, function() -- Cancel
        QBCore.Functions.Notify(_U('canceled'), 'error', 2500)
    end)
end)

RegisterNetEvent('nmsh-weedplanting:client:GiveFertilizer', function(entity)
    if QBCore.Functions.HasItem(Shared.FertilizerItem, 1) then
        ...
        QBCore.Functions.Progressbar('weedplanting_fertilizer', _U('fertilizing_plant'), 6000, false, false, {
            ...
            TriggerServerEvent('nmsh-weedplanting:server:GiveFertilizer', netId)
            ClearPedTasks(ped)
            DeleteEntity(created_object)
        end, function()
            ClearPedTasks(ped)
...
RegisterNetEvent('nmsh-weedplanting:client:AddMaleSeed', function(entity)
    if QBCore.Functions.HasItem(Shared.MaleSeed, 1) then
        ...
        QBCore.Functions.Progressbar('add_maleseed', _U('adding_male_seed'), 8500, false, true, {
            ...
            TriggerServerEvent('nmsh-weedplanting:server:AddMaleSeed', netId)
            ClearPedTasks(ped)
            RemoveAnimDict('amb@medic@standing@kneel@base')
            RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
        end, function()
...
CreateThread(function()
    exports['nmsh-target']:AddTargetModel(Shared.WeedProps, {
        options = {
            {
                type = 'client',
                event = 'nmsh-weedplanting:client:CheckPlant',
