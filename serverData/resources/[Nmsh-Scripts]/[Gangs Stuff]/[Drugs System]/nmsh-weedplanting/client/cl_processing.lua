...
CreateThread(function ()
    ...
    exports['nmsh-target']:AddBoxZone('weedprocess', vector3(1045.4, -3197.62, -38.16), 2.3, 1.0, {
        name = 'weedprocess',
        heading = 0,
        minZ = -41.16,
        maxZ = -37.50,
        ...
        options = {
            {
                type = 'client',
                event = 'nmsh-weedplanting:client:ProcessBranch',
                icon = 'fa-solid fa-cannabis',
                label = _U('process_branch'),
            },
            { -- Create Package
                type = 'client',
                event = 'nmsh-weedplanting:client:PackDryWeed',
    ...
    if Shared.WeedLab.EnableTp then
        exports['nmsh-target']:AddBoxZone('weedlab-enter', vector3(-66.95, -1311.66, 29.27), 1.5, 0.5, {
            name = 'weedlab-enter',
            heading = 90,
            minZ = 29.27 - 2,
            maxZ = 29.27 + 2,
            ...
            options = {
                {
                    type = 'client',
                    event = 'nmsh-weedplanting:client:EnterLab',
        ...
        exports['nmsh-target']:AddBoxZone('weedlab-exit', vector3(1066.65, -3183.45, -39.16), 1.5, 0.5, {
            name = 'weedlab-exit',
            heading = 0,
            minZ = -39.16 - 2,
            maxZ = -39.16 + 2,
            ...
            options = {
                {
                    type = 'client',
                    event = 'nmsh-weedplanting:client:ExitLab',
                    icon = 'fa-solid fa-warehouse',
...
RegisterNetEvent('nmsh-weedplanting:client:EnterLab', function()
...
RegisterNetEvent('nmsh-weedplanting:client:ExitLab', function()
...
RegisterNetEvent('nmsh-weedplanting:client:ProcessBranch', function()
    ...
    QBCore.Functions.Progressbar('weedbranch', _U('processing_branch'), 12000, false, true, {
        ...
        TriggerServerEvent('nmsh-weedplanting:server:ProcessBranch')
    end, function() -- Cancel
...
RegisterNetEvent('nmsh-weedplanting:client:PackDryWeed', function()
    ...
    QBCore.Functions.Progressbar('dryweed', _U('packaging_weed'), 12000, false, true, {
        ...
        TriggerServerEvent('nmsh-weedplanting:server:PackageWeed')
    end, function() -- Cancel
        QBCore.Functions.Notify(_U('canceled'), 'error', 2500)
        ClearPedTasks(ped)
    end)
