...
local function installing_gunrack()
     ...
     QBCore.Functions.Progressbar("keep_gunrack_install", Lang:t('progressbar.installing_gun_rack'), duration, false,
          ...
          TriggerServerEvent('nmsh-gunrack:server:create_gunrack', plate)
     end)
end
...
RegisterNetEvent('nmsh-gunrack:client:start_installing_gunrack', function()
     installing_gunrack()
end)

RegisterNetEvent("nmsh-gunrack:client:open_gunrack", function(plate)
...
AddEventHandler("nmsh-gunrack:client:open_gunrack_menu", function()
     local player_ped = PlayerPedId()
     local veh = nil
     ...
     TriggerServerEvent('nmsh-gunrack:server:open_gunrack', plate)
end)
...
if Config.gunrack.use_keys_to_unlock_gunrack then
     ...
     RegisterNetEvent('nmsh-gunrack:client:cut_key', function()
          ...
          if inputData then
               ...
               TriggerServerEvent('nmsh-gunrack:server:start_cut_key', inputData.PLATE)
          end
     end)

     RegisterNetEvent('nmsh-gunrack:client:keycuttingmachine_animation', function(plate)
          QBCore.Functions.Progressbar("keep_gunrack_keycuttingmachine", Lang:t('progressbar.cutting_key'),
               ...
               TriggerServerEvent('nmsh-gunrack:server:cut_key', plate)
          end)
     end)
end
