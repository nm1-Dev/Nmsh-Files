...
RegisterNetEvent("nmsh-dispatch:client:AddCallBlip", function(coords, data, blipId)
...
RegisterNetEvent("nmsh-dispatch:client:Explosion", function(data)
	exports["nmsh-dispatch"]:Explosion()
end)

RegisterNetEvent("nmsh-dispatch:client:removeCallBlip", function(blipId)
	RemoveBlip(blips[blipId])
	RemoveBlip(radius2[blipId])
end)

RegisterNetEvent("nmsh-dispatch:client:clearAllBlips", function()
