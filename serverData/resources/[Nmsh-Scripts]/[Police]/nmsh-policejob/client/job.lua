...
RegisterNetEvent('qb-police:client:openArmoury', function()
    if PlayerJob.name == "police" then
        ...
        QBCore.Functions.Notify('What Are you doing ?? Nmsh Don\'t Try the Other Triggers or you will get banned')
    end
end)
...
if Config.UseTarget then
    CreateThread(function()
        ...
        for k, v in pairs(Config.Locations["labs"]) do
            exports['nmsh-target']:AddBoxZone("PoliceLabs"..k, vector3(v.x,v.y,v.z), 0.8, 0.6, {
        ...
        exports['nmsh-target']:AddTargetBone('seat_dside_f', {
        options = {{
