...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
	...
	TriggerEvent("nmsh-communityservice:inCommunityService", PlayerData.metadata.communityservice)
end)
...
RegisterNetEvent('nmsh-communityservice:inCommunityService')
AddEventHandler('nmsh-communityservice:inCommunityService', function(actions_remaining)
	...
	while actionsRemaining > 0 and not communityServiceFinished do
		...
		if mesafe > 45 then
			...
			TriggerServerEvent('nmsh-communityservice:extendService')
	...
	TriggerServerEvent('nmsh-communityservice:finishCommunityService', QBCore.Key)

	isSentenced = false
end)

RegisterNetEvent('nmsh-communityservice:finishCommunityService')
AddEventHandler('nmsh-communityservice:finishCommunityService', function(source)
			...
			for i = 1, #availableActions do
				...
				if distance < 1.5 then
					...
					if(IsControlJustReleased(1, 38))then
						...
						TriggerServerEvent('nmsh-communityservice:completeService', QBCore.Key)
...
RegisterCommand("comserv", function()
	...
	local qbinput1 = exports['nmsh-input']:ShowInput({
