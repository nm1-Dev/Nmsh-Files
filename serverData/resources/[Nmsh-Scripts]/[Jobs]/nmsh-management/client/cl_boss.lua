...
RegisterNetEvent('nmsh-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            params = {
                event = "nmsh-bossmenu:client:employeelist",
            }
        },
        {
            ...
            params = {
                event = "nmsh-bossmenu:client:HireMenu",
            }
        },
        {
            ...
            params = {
                event = "nmsh-bossmenu:client:Stash",
            }
        },
        {
            ...
            params = {
                event = "nmsh-bossmenu:client:Wardrobe",
            }
        },
        {
            ...
            params = {
                event = "nmsh-bossmenu:client:SocietyMenu",
            }
        },
    }
    ...
    exports['nmsh-menu']:openMenu(bossMenu)
end)

RegisterNetEvent('nmsh-bossmenu:client:employeelist', function()
    local EmployeesMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('nmsh-bossmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            EmployeesMenu[#EmployeesMenu + 1] = {
                ...
                params = {
                    event = "nmsh-bossmenu:client:ManageEmployee",
                    args = {
                        player = v,
                        work = PlayerJob
                    }
        ...
        EmployeesMenu[#EmployeesMenu + 1] = {
            ...
            icon = "fa-solid fa-angle-left",
            params = {
                event = "nmsh-bossmenu:client:OpenMenu",
            }
        }
        exports['nmsh-menu']:openMenu(EmployeesMenu)
    end, PlayerJob.name)
end)

RegisterNetEvent('nmsh-bossmenu:client:ManageEmployee', function(data)
    local EmployeeMenu = {
        {
    ...
    for k, v in pairs(QBCore.Shared.Jobs[data.work.name].grades) do
        EmployeeMenu[#EmployeeMenu + 1] = {
            ...
            params = {
                isServer = true,
                event = "nmsh-bossmenu:server:GradeUpdate",
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = "nmsh-bossmenu:server:FireEmployee",
    ...
    exports['nmsh-menu']:openMenu(EmployeeMenu)
end)

RegisterNetEvent('nmsh-bossmenu:client:Stash', function()
...
RegisterNetEvent('nmsh-bossmenu:client:Wardrobe', function()
    TriggerEvent('nmsh-clothing:client:openOutfitMenu')
end)

RegisterNetEvent('nmsh-bossmenu:client:HireMenu', function()
    local HireMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('nmsh-bossmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMenu[#HireMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = "nmsh-bossmenu:server:HireEmployee",
                        args = v.sourceplayer
                    }
                }
            end
        ...
        exports['nmsh-menu']:openMenu(HireMenu)
    end)
end)

RegisterNetEvent('nmsh-bossmenu:client:SocietyMenu', function()
    QBCore.Functions.TriggerCallback('nmsh-bossmenu:server:GetAccount', function(cb)
        local SocietyMenu = {
            {
            ...
            },
            {
                ...
                params = {
                    event = "nmsh-bossmenu:client:SocetyDeposit",
                    args = comma_value(cb)
                }
            },
            {
                ...
                params = {
                    event = "nmsh-bossmenu:client:SocetyWithDraw",
                    args = comma_value(cb)
                }
            },
            {
...
RegisterNetEvent('nmsh-bossmenu:client:SocetyDeposit', function(money)
    ...
    if deposit then
        ...
        TriggerServerEvent("nmsh-bossmenu:server:depositMoney", tonumber(deposit.amount))
    end
end)

RegisterNetEvent('nmsh-bossmenu:client:SocetyWithDraw', function(money)
    ...
    if withdraw then
        ...
        TriggerServerEvent("nmsh-bossmenu:server:withdrawMoney", tonumber(withdraw.amount))
    end
end)
    ...
    if Config.UseTarget then
        for job, zones in pairs(Config.BossMenuZones) do
            for index, data in ipairs(zones) do
                exports['nmsh-target']:AddBoxZone(job.."-BossMenu-"..index, data.coords, data.length, data.width, {
