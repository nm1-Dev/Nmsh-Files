...
RegisterNetEvent('nmsh-simplefarming:slaughter1', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedcow) then
        ...
        QBCore.Functions.Progressbar('killing_cow', Config.Alerts['killing_cow'], 12000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          ...
          disableCombat = true,
              ...
              TriggerServerEvent('nmsh-simplefarming:cowkilling')
...
RegisterNetEvent('nmsh-simplefarming:slaughter2', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:slaughter3', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:slaughter4', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig1', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"Mechanic3"})
        QBCore.Functions.Progressbar('Killing_Pig', Config.Alerts['killing_pig'], 12000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          ...
          disableCombat = true,
            ...
            TriggerEvent('animations:client:EmoteCommandStart', {"c"})
            ClearPedTasks(PlayerPedId())
            TriggerServerEvent('nmsh-simplefarming:slayreward')
            TriggerServerEvent('hud:Server:GainStress', math.random(1, 2))
            Wait(1200000) -- 20 minutes
            pedpig1 = CreatePed(1, 0xB11BAB56, 2149.41, 5013.96, 41.39, 223.72, 0, false, true)
          end, function()
...
RegisterNetEvent('nmsh-simplefarming:killpig2', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig3', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig4', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig5', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig6', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig7', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig8', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig9', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig10', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig11', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig12', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig13', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig14', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig15', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
...
RegisterNetEvent('nmsh-simplefarming:killpig16', function()
  QBCore.Functions.TriggerCallback('nmsh-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
