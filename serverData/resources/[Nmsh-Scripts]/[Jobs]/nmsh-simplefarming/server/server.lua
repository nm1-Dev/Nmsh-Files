...
RegisterServerEvent('nmsh-simplefarming:applepicking', function()
    local source = source
...
RegisterServerEvent('nmsh-simplefarming:appleprocess', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:apples', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:weapon_knife', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:cowmeat', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:emptycowbucket', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:milkbucketfull', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('nmsh-simplefarming:cowmilking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:cowkilling', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:beefprocess', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:getcowbucket', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:dairymilk', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:pumpkinpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:pumpkinprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:pumpkincheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:corncheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('nmsh-simplefarming:cornpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:cornprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:grapecheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:greenpeppercheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:chillycheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:tomatoescheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('nmsh-simplefarming:grapepicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:grapeprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:gpepperpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:chypepperpicking', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:makinghotsauce', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:tomatoespicking', function()
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterServerEvent('nmsh-simplefarming:tomatoesprocessing', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:soybeancheck', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:rawbacon', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:rawham', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:rawpork', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
QBCore.Functions.CreateCallback('nmsh-simplefarming:rawsausage', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player ~= nil then
...
RegisterServerEvent('nmsh-simplefarming:baconprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:hamprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:porkprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:sausageprocessed', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:pigfood', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
...
RegisterServerEvent('nmsh-simplefarming:feedingpiglit', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
    ...
    TriggerClientEvent('nmsh-simplefarming:relievestress', source)
end)

RegisterNetEvent('nmsh-simplefarming:slayreward', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
