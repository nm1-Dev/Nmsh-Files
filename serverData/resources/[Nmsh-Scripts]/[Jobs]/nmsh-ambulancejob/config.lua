...
Config.BillCost = 150 -- Price that players are charged for using the hospital check-in system
...
Config.FuelScript = 'nmsh-fuel' -- Fuel script u use (defaut: nmsh-fuel)
