...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:pump_fueloil', function(source, cb, data)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:PumpOilToStorageCallback', function(source, cb, data)
     local player = QBCore.Functions.GetPlayer(source)
     if player == nil then
          TriggerClientEvent('QBCore:Notify', source, "failed to find player!")
          cb(false)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:getStorageData', function(source, cb)
     local player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:Withdraw', function(source, cb, data)
...
RegisterNetEvent('nmsh-oilwell:server:purgeWithdrawStash', function()
     local Player = QBCore.Functions.GetPlayer(source)
     local stash = 'Withdraw_' .. Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:withdraw_from_queue', function(source, cb, Type)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
     local storage = GlobalScirptData:getDeviceByCitizenId('oilrig_storage', citizenid)
     if storage == false then
...
QBCore.Functions.CreateUseableItem('oilwell', function(source, item)
     ...
     TriggerClientEvent('nmsh-inventory:client:ItemBox', source, QBCore.Shared.Items['oilwell'], "remove")

     if item.amount >= 1 and RemovedItem == true then
          TriggerClientEvent('nmsh-oilrig:client:spawn', source)
     end
end)
...
RegisterNetEvent('nmsh-oilrig:server:updateSpeed', function(inputData, id)
     local player = QBCore.Functions.GetPlayer(source)
     ...
     TriggerClientEvent('nmsh-oilrig:client:syncSpeed', -1, id, speed)
end)

QBCore.Functions.CreateCallback('nmsh-oilrig:server:get_CDU_Data', function(source, cb)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:set_CDU_temp', function(source, cb, inputData)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:switchPower_of_CDU', function(source, cb)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
     local CDU = GlobalScirptData:getDeviceByCitizenId('oilrig_cdu', citizenid)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:pumpCrudeOil_to_CDU', function(source, cb, inputData)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:ShowBlender', function(source, cb)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:toggle_blender', function(source, cb)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
     local blender = GlobalScirptData:getDeviceByCitizenId('oilrig_blender', citizenid)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:recipe_blender', function(source, cb, inputData)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
     local blender = GlobalScirptData:getDeviceByCitizenId('oilrig_blender', citizenid)
...
local function remove_item(source, Player, name, slot)
     ...
     TriggerClientEvent('nmsh-inventory:client:ItemBox', source, QBCore.Shared.Items[name], "remove")
end

QBCore.Functions.CreateCallback('nmsh-oilrig:server:oil_transport:fillTransportWell', function(source, cb, amount)
     ...
     if current_info.gal > amount then
          ...
          TriggerClientEvent('nmsh-oilrig:client:local_mail_sender', source, {
               gender = gender,
               charinfo = charinfo,
               refund = 0,
               money = cost,
...
RegisterNetEvent('nmsh-oilrig:server:oil_transport:checkPrice', function()
     local names      = {
          crudeOil = 'Crude Oil',
          gasoline = 'Gasoline',
          fuel_oil = 'Fuel Oil'
...
---@param cb table
QBCore.Functions.CreateCallback('nmsh-oilrig:server:getNetIDs', function(source, cb)
     local player = QBCore.Functions.GetPlayer(source)
     local citizenid = player.PlayerData.citizenid
     local temp = {}
...
---@param coords table
---@return 'NetId'
QBCore.Functions.CreateCallback('nmsh-oilrig:server:createNewOilrig', function(source, cb, coords)
...
QBCore.Functions.CreateCallback('nmsh-oilrig:server:regiserOilrig', function(source, cb, inputData)
     ...
     if player ~= nil then
          ...
          TriggerClientEvent('nmsh-oilwell:client:force_reload', -1)
          cb(true)
     else
...
QBCore.Functions.CreateCallback('nmsh-oilwell:server:fix_oil_well', function(source, cb, oilrig_hash)
     local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('nmsh-oilwell:server:is_employee', function(source, cb, oilrig_hash)
     local Player = QBCore.Functions.GetPlayer(source)
     local oil_well = GlobalScirptData:getByHash(oilrig_hash)
     if not oil_well then cb(false) return end
...
QBCore.Functions.CreateCallback('nmsh-oilwell:server:employees_list', function(source, cb, oilrig_hash)
     local Player = QBCore.Functions.GetPlayer(source)
     local oil_well = GlobalScirptData:getByHash(oilrig_hash)
     if not oil_well then cb(false) return end
     local is_employee, is_owner = oil_well.is_employee(Player.PlayerData.citizenid)
...
RegisterNetEvent('nmsh-oilwell:server:add_employee', function(oilrig_hash, state_id)
...
RegisterNetEvent('nmsh-oilwell:server:remove_employee', function(oilrig_hash, citizenid)
...
QBCore.Functions.CreateCallback('nmsh-oilwell:server:oilwell_metadata', function(source, cb, oilrig_hash)
     local oil_well = GlobalScirptData:getByHash(oilrig_hash)
     if not oil_well then cb(false) return end
     cb(oil_well.metadata)
end)

RegisterNetEvent('nmsh-oilwell:server:remove_oilwell', function(oilrig_hash)
...
QBCore.Commands.Add('create', 'create new oilwell', {}, false, function(source, args)
     if args[1] == 'oilwell' then
          TriggerClientEvent('nmsh-oilrig:client:spawn', source, args[1])
     end
end, 'admin')
...
QBCore.Commands.Add('togglejob', 'togglejob', {}, false, function(source, args)
     ...
     TriggerClientEvent('nmsh-oilrig:client:goOnDuty', source, PlayerJob)
end, 'admin')
