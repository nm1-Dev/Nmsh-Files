...
function Targets.qb_target.storage(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone(name, tmp_coord, 1, {
        name = name,
        debugPoly = debugPoly,
        useZ = true
    }, {
...
function Targets.qb_target.distillation(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone(name, tmp_coord, 1.2, {
        name = name,
        debugPoly = debugPoly,
        useZ = true
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilrig:CDU_menu:ShowCDU",
...
function Targets.qb_target.toggle_job(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone(name, tmp_coord, 0.75, {
        name = name,
        debugPoly = debugPoly,
        useZ = true
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilrig:client:goOnDuty",
...
function Targets.qb_target.barrel_withdraw(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone(name, tmp_coord, 1.0, {
        name = name,
        debugPoly = debugPoly,
        useZ = true
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilrig:client_lib:withdraw_from_queue",
                icon = "fa-solid fa-boxes-packing",
            ...
            {
                type = "client",
                event = "nmsh-oilwell:client:openWithdrawStash",
                icon = "fa-solid fa-boxes-packing",
            ...
            {
                type = "client",
                event = "nmsh-oilwell:client:open_purge_menu",
...
function Targets.qb_target.blender(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone(name, tmp_coord, 3.5, {
        name = name,
        debugPoly = debugPoly,
        useZ = true
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilrig:blender_menu:ShowBlender",
                icon = "fa-solid fa-gear",
...
function Targets.qb_target.crude_oil_transport(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone(name, tmp_coord, 2, {
        name = name,
        debugPoly = debugPoly,
        useZ = true
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilwell:menu:show_transport_menu",
                icon = "fa-solid fa-boxes-packing",
...
function Targets.qb_target.oilwell(coords, name)
    ...
    exports['nmsh-target']:AddCircleZone("oil-rig-" .. name, coord, 3.5, {
        name = "oil-rig-" .. name,
        debugPoly = true,
        useZ = true,
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilrig:client:viewPumpInfo",
            ...
            {
                type = "client",
                event = "nmsh-oilrig:client:changeRigSpeed",
            ...
            {
                type = "client",
                event = "nmsh-oilrig:client:show_oilwell_stash",
            ...
            {
                type = "client",
                event = "nmsh-oilwell:client:remove_oilwell",
...
function Targets.qb_target.truck(plate, truck)
    exports['nmsh-target']:AddEntityZone("device-" .. plate, truck, {
        name = "device-" .. plate,
        debugPoly = false,
    }, {
        options = {
            {
                type = "client",
                event = "nmsh-oilwell:client:refund_truck",
