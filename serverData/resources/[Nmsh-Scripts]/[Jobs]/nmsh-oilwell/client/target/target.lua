...
local function makeCore()
     ...
     Citizen.CreateThread(function()
          ...
          exports['nmsh-target']:AddBoxZone("keep_oilwell_withdraw_truck_target", vec3_coord,
...
AddEventHandler('nmsh-oilwell:client:refund_truck', function(data)
     ...
     QBCore.Functions.TriggerCallback('nmsh-oilwell:server:refund_truck', function(result)
          if result == true then
