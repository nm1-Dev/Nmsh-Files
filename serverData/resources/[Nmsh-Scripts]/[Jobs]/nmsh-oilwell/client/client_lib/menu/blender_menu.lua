...
local function showblender(data)
     ...
     openMenu[#openMenu + 1] = {
          ...
          params = {
               event = "nmsh-oilrig:blender_menu:recipe_blender"
          }
     }
     ...
     openMenu[#openMenu + 1] = {
          ...
          icon = start_icon,
          params = {
               event = "nmsh-oilrig:blender_menu:toggle_blender"
          }
     }
     ...
     openMenu[#openMenu + 1] = {
          ...
          params = {
               event = "nmsh-oilrig:blender_menu:pump_fueloil"
          }
     }
...
AddEventHandler('nmsh-oilrig:blender_menu:pump_fueloil', function()
     QBCore.Functions.TriggerCallback('nmsh-oilrig:server:pump_fueloil', function(result)
          showblender(result)
     end)
end)

AddEventHandler('nmsh-oilrig:blender_menu:ShowBlender', function()
     QBCore.Functions.TriggerCallback('nmsh-oilrig:server:ShowBlender', function(result)
          showblender(result)
     end)
end)

AddEventHandler('nmsh-oilrig:blender_menu:toggle_blender', function()
     QBCore.Functions.TriggerCallback('nmsh-oilrig:server:toggle_blender', function(result)
          showblender(result)
     end)
end)
...
AddEventHandler('nmsh-oilrig:blender_menu:recipe_blender', function()
     ...
     if inputData then
          ...
          QBCore.Functions.TriggerCallback('nmsh-oilrig:server:recipe_blender', function(result)
               showblender(result)
          end, inputData)
     end
end)
