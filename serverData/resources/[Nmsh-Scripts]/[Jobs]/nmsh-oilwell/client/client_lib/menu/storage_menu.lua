     ...
     local openMenu = {
          {
               ...
               params = {
                    event = 'nmsh-oilrig:storage_menu:StorageActions',
                    args = {
                         type = 'crudeOil',
     ...
     local openMenu = {
          {
               ...
               txt = "",
               params = {
                    event = 'nmsh-oilrig:storage_menu:StorageWithdraw',
                    args = data
               }
          },
          {
          ...
          },
          {
               ...
               params = {
                    event = "nmsh-oilrig:storage_menu:ShowStorage"
               }
          }
     }
...
local function showStorageWithdraw(data)
     ...
     local openMenu = {
          ...
          },
          {
               ...
               params = {
                    event = 'nmsh-oilrig:storage_menu:Callback',
                    args = {
                         eventName = 'nmsh-oilrig:server:Withdraw',
...
MakeVehicle = function(model, Coord, TriggerLocation, DinstanceToTrigger, items)
     ...
     TriggerServerEvent('nmsh-oilwell:server_lib:update_vehicle', vehiclePlate, items)
end


RegisterNetEvent('nmsh-oilrig:client_lib:withdraw_from_queue', function(data)
     QBCore.Functions.TriggerCallback('nmsh-oilrig:server:withdraw_from_queue', function(result)
          -- res >> table of items
...
AddEventHandler('nmsh-oilrig:storage_menu:ShowStorage', function(data)
     QBCore.Functions.TriggerCallback('nmsh-oilrig:server:getStorageData', function(result)
          showStorage(result)
     end)
end)

AddEventHandler('nmsh-oilrig:storage_menu:StorageActions', function(storage_data)
     showStorageActions(storage_data)
end)

AddEventHandler('nmsh-oilrig:storage_menu:StorageWithdraw', function(data)
     showStorageWithdraw(data)
end)

AddEventHandler('nmsh-oilrig:storage_menu:Callback', function(data)
...
-- withdraw spot
AddEventHandler("nmsh-oilwell:client:openWithdrawStash", function(data)
...
local function purge_menu()
     local openMenu = {
          ...
          },
          {
               ...
               params = {
                    event = 'nmsh-oilwell:client:purgeWithdrawStash',
               }
          },
          {
               header = 'Cancel',
...
AddEventHandler('nmsh-oilwell:client:open_purge_menu', function()
     purge_menu()
end)

local purge_conf = 0
AddEventHandler('nmsh-oilwell:client:purgeWithdrawStash', function()
     ...
     purge_conf = 0
     TriggerServerEvent('nmsh-oilwell:server:purgeWithdrawStash')
end)
