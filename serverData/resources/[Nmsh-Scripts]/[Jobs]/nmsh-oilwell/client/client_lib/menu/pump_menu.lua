...
local function showInfo(data)
     QBCore.Functions.TriggerCallback('nmsh-oilwell:server:oilwell_metadata', function(selected_oilrig)
          ...
          local openMenu = {
               ...
               },
               {
                    ...
                    params = {
                         event = 'nmsh-oilrig:storage_menu:PumpOilToStorage',
                         args = {
               ...
               },
               {
                    ...
                    params = {
                         event = 'nmsh-oilwell:menu:ManageEmployees',
...
RegisterNetEvent('nmsh-oilwell:menu:ManageEmployees', function(oilrig_hash)
     QBCore.Functions.TriggerCallback('nmsh-oilwell:server:employees_list', function(result)
          ...
          Menu[#Menu + 1] = {
               ...
               params = {
                    event = "nmsh-oilwell:client:add_employee",
                    args = {
          ...
          for index, employee in ipairs(result) do
               ...
               Menu[#Menu + 1] = {
                    ...
                    params = {
                         event = "nmsh-oilwell:menu:remove_employee",
                         args = {
                              employee = employee,
                              oilrig_hash = oilrig_hash
                         }
...
RegisterNetEvent('nmsh-oilwell:client:add_employee', function(data)
     ...
     if inputData then
          ...
          TriggerServerEvent('nmsh-oilwell:server:add_employee', data.oilrig_hash, inputData.stateId)
     end
end)

RegisterNetEvent('nmsh-oilwell:menu:remove_employee', function(data)
     ...
     local Menu = {
          ...
          },
          {
               ...
               params = {
                    event = "nmsh-oilwell:menu:fire_employee",
                    args = {
...
RegisterNetEvent('nmsh-oilwell:menu:fire_employee', function(data)
     TriggerServerEvent('nmsh-oilwell:server:remove_employee', data.oilrig_hash, data.employee.citizenid)
end)
     ...
     QBCore.Functions.TriggerCallback('nmsh-oilwell:server:oilwell_metadata', function(selected_oilrig)
          ...
          local openMenu = {
               ...
               },
               {
                    ...
                    params = {
                         event = 'nmsh-oilwell:client:openOilPump',
                         args = {
                              oilrig_hash = data.oilrig_hash
                         }
                    }
               },
               {
                    ...
                    params = {
                         event = 'nmsh-oilwell:client:fix_oilwell',
                         args = {
                              oilrig_hash = data.oilrig_hash
                         }
                    }
...
-- Events
AddEventHandler('nmsh-oilrig:storage_menu:PumpOilToStorage', function(data)
     QBCore.Functions.TriggerCallback('nmsh-oilrig:server:PumpOilToStorageCallback', function(result)

     end, data.oilrig_hash)
end)

AddEventHandler('nmsh-oilrig:client:viewPumpInfo', function(qbtarget)
...
AddEventHandler('nmsh-oilrig:client:show_oilwell_stash', function(qbtarget)
     -- ask for updated data
     OilRigs:startUpdate(function()
...
-- Open oil pump stash.
RegisterNetEvent("nmsh-oilwell:client:openOilPump", function(data)
...
AddEventHandler('nmsh-oilwell:client:fix_oilwell', function(data)
     -- ask for updated data
     QBCore.Functions.TriggerCallback('nmsh-oilwell:server:fix_oil_well', function(result)
          print(result)
     end, data.oilrig_hash)
