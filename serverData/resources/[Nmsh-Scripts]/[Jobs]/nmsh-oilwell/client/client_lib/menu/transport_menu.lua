...
local function show_transport_menu()
     ...
     local openMenu = {
          ...
          },
          {
               ...
               txt = "",
               params = {
                    event = 'nmsh-oilwell:menu:show_transport_menu:ask_stock_price',
               }
          },
          {
               ...
               txt = "",
               params = {
                    event = 'nmsh-oilwell:menu:show_transport_menu:ask_to_sell_amount',
               }
          },
          {
               header = 'leave',
...
AddEventHandler('nmsh-oilwell:menu:show_transport_menu', function()
     show_transport_menu()
end)

AddEventHandler('nmsh-oilwell:menu:show_transport_menu:ask_stock_price', function()
     TriggerServerEvent('nmsh-oilrig:server:oil_transport:checkPrice')
end)
...
AddEventHandler('nmsh-oilwell:menu:show_transport_menu:ask_to_sell_amount', function()
     ...
     if inputData then
          ...
          QBCore.Functions.Progressbar("keep_oilwell_transport", 'Filling', Oilwell_config.Transport.duration * 1000,
               ...
               QBCore.Functions.TriggerCallback('nmsh-oilrig:server:oil_transport:fillTransportWell', function(res)
