...
QBCore.Commands.Add(Config.Command.OpenUI, 'Open Easy Time Menu', {}, false, function(source)
    TriggerClientEvent('cd_easytime:OpenUI', source, self)
end, 'admin')

QBCore.Commands.Add('weather', 'Open Easy Time Menu', {}, false, function(source)
    TriggerClientEvent('cd_easytime:OpenUI', source, self)
end, 'admin')
