...
Targets = function()
	local target = GetResourceState('ox_target') == 'started' and "ox_target" or GetResourceState('nmsh-target') == 'started' and "nmsh-target" or GetResourceState('qtarget') == 'started' and 'qtarget'
