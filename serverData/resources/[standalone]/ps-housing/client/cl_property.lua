...
function Property:RegisterGarageZone()
    ...
    TriggerEvent("nmsh-garages:client:addHouseGarage", self.property_id, data)
    ...
    self.garageZone = lib.zones.box({
        ...
        onEnter = function()
            TriggerEvent('nmsh-garages:client:setHouseGarage', self.property_id, true)
        end,
    })
end
...
function Property:UnregisterGarageZone()
    ...
    TriggerEvent("nmsh-garages:client:removeHouseGarage", self.property_id)
