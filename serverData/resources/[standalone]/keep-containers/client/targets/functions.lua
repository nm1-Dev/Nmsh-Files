...
function TransferOwnership( private, entity )
    ...
    if Framework == 1 then
        local inputData = exports[Config.input]:ShowInput({
            header = "Transfer Ownership", -- nmsh-input
            inputs = {
                {
                    type = "number",
                    name = "new_owner",
                    ...
                    text = "New Owner's State Id", -- nmsh-input
                    isRequired = true
                }
            }
        })
...
function ChangePassword( private, entity )
    ...
    if Framework == 1 then
        local Input = {
            header = "Change Password", -- nmsh-input
            inputs = {
                {
                    type = "password",
                    ...
                    text = "Current Password", -- nmsh-input
                    isRequired = true
                },
                {
                    type = "password",
...
function OpenContainer( private, entity )
    ...
    if Framework == 1 then
        local Input = {
            header = "Container Password", -- nmsh-input
            inputs = {
                {
                    type = "password",
                    name = "password",
                    icon = "fa-solid fa-money-bill-trend-up",
                    title = "Password",
                    text = "Enter Password", -- nmsh-input
                    isRequired = true
                }
            }
        }
